...
public class TwitterClient extends OAuthBaseClient {
	...
	public static final String REST_CALLBACK_URL = "oauth://CPTwitterAppCBB"; // Change this (here and in manifest)
    ...
    void getRateLimit(AsyncHttpResponseHandler handler) {
		...
		// Can specify query string params directly or through RequestParams.
		RequestParams params = new RequestParams();
		params.put("resources", "help,users,search,statusesount");
		client.get(apiUrl, params, handler);
    }
